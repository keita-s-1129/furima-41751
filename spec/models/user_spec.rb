...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録できるとき' do
      it 'nickname、email、password、password_confirmation、first_name、last_name、first_kana、last_kana、birthdayが入力できれば登録できる' do
    ...
    context '新規登録できないとき' do
      ...
      it 'passwordとpassword_confirmationが不一致では登録できない' do
        ...
        @user.password_confirmation = '1234abcc'
        @user.valid?
      ...
      it 'passwordは全角が含まれると登録はできない' do
        @user.password = '111aaaあああ'
        @user.password_confirmation = '111aaaあああ'
        @user.valid?
        expect(@user.errors.full_messages).to include 'Password is invalid. Include both letters and numbers'
      end
